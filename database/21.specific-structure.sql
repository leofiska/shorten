...
CREATE TABLE tb_shortener (
  ...
  short_global_id       bigint DEFAULT NULL REFERENCES tb_global_ids (global_id) ON DELETE SET NULL,
...
GRANT SELECT, DELETE, INSERT ( short_url, short_uuid, short_global_id, short_session_id, short_user_id ), UPDATE ( short_unique_counter ) ON tb_shortener TO :var_user;
